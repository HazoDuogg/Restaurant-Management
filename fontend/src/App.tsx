...
function AuthRole({ children, roles }: { children: React.JSX.Element, roles: string[] }) {
  ...
  const showNotification = useNotificationStore((e) => e.show);
  ...
  }, [hasAccess, userRole, showNotification, navigate]);
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/reservations" element={<AuthRole roles={["ADMIN", "STAFF"]}><AdminReservationsPage /></AuthRole>} />
